<div class="py-2 mb-4 max-w-4xl mx-auto">
    <h2 class="text-2xl md:text-xl text-gray-600 text-center font-normal mb-2">Buscar piñatas</h2>
    <div class=" mx-auto">
        <form class="mx-4" wire:submit.prevent='leerFormulario' novalidate>
            <div class="md:grid md:grid-cols-2 gap-5">
                <div class="mb-5">
                    ...
                    <input id="termino" type="text" placeholder="Ej. merlina" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" wire:model='nombre'
                    />
                </div>
                <div class="mb-5">
