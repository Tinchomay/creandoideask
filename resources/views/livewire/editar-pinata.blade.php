<div class="flex flex-col sm:justify-center items-center bg-gray-100">
    <form class="md:w-2/5 mx-6 mb-6" novalidate wire:submit.prevent='editarPinata'>
        @csrf
        <div class=" mt-2 mb-4">
            Imagen Anterior
            <img class=" max-h-40"  src="{{ asset('storage/pinatas') . '/' . $imagen_anterior }}" alt="Imagen a subir">
            </div>
        <div class="mb-4">
